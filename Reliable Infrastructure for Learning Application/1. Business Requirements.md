...
* Learners have access to a customized "For You" Page to keep them engaged and motivated. It includes several interactive and informative features like:
...
* Teachers have access to an analytics dashboard that highlights relevant metrics related to their content such as number of views, learner engagement, feedback, etcetera
